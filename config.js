// Utilitário para congelamento profundo de objetos aninhados[cite: 3]
...
export const CONFIG = deepFreeze({
    ...
    POLICIAS_CONCORRENTES: ["DPH", "DOH", "DME", "DIC", "CSI", "PMH"], //[cite: 3]
    COMANDOS_PROIBIDOS: [
        "porta1", "pk1", "visu01", "iniciartempo", "zerartempo", "fecharportas", 
        "limparsaguao", "sentido", "continencia", "idle", "sit", "kickall", "mute"
    ], //[cite: 3]
    REGRAS_FARDAMENTO: {
        ALLOWED_WAIST: [3263], //[cite: 3]
        ALLOWED_WAIST_COLORS: [110, 64, 92, 1408], //[cite: 3]
        ALLOWED_HE: [1605], //[cite: 3]
        ALLOWED_CC_EXEC: [260, 3008], //[cite: 3]
        ALLOWED_CH_EXEC: [3076, 820, 225], //[cite: 3]
        ALLOWED_HD: [180, 185, 190, 195, 200, 205, 206, 207, 208, 209, 3091, 3092, 3093, 3094, 3095, 3101, 3102, 3103, 3997, 600, 605, 610, 615, 620, 625, 626, 627, 628, 629, 3096, 3097, 3098, 3099, 3100, 3104, 3105, 3106], //[cite: 3]
        ALLOWED_EA: [1403, 1402, 1401, 1404, 3169, 3107, 3168, 3484, 5135, 5576, 5897, 6196, 6270, 5626], //[cite: 3]
        ALLOWED_EA_COLORS: [64, 110, 1408, 92], //[cite: 3]
        ALLOWED_FA: [1201, 1206, 1208, 3344, 3993, 5211, 5386, 5636, 4283], //[cite: 3]
        ALLOWED_HR: [893, 3531, 155, 5772, 4117, 828, 5791, 3936, 115, 832, 3163, 540, 530, 555, 835, 681, 836, 834, 811, 864, 867, 869, 890, 874, 3004, 3012, 3090, 3322, 3499, 3569, 3568, 3665, 3676, 3625, 3519, 3785, 3786, 3829, 3746, 3994, 3998, 4090, 4162, 4298, 5019, 5275, 5437, 5606, 5617, 6034, 5971, 9534] //[cite: 3]
    },
    REGRAS_POR_PATENTE: {
    ...
    API_BASE_URL: "https://www.habbo.com.br/api/public" //[cite: 3]
});